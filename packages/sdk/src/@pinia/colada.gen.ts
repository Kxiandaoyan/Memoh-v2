...
export const getBotsByBotIdEvolutionLogsQueryKey = (options: Options<GetBotsByBotIdEvolutionLogsData>) => createQueryKey('getBotsByBotIdEvolutionLogs', options);
 ...
 */
export const getBotsByBotIdEvolutionLogsQuery = defineQueryOptions((options: Options<GetBotsByBotIdEvolutionLogsData>) => ({
    key: getBotsByBotIdEvolutionLogsQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdEvolutionLogs({
            ...options,
            ...context,
            throwOnError: true
        });
...
export const getBotsByBotIdEvolutionLogsByIdQueryKey = (options: Options<GetBotsByBotIdEvolutionLogsByIdData>) => createQueryKey('getBotsByBotIdEvolutionLogsById', options);
 ...
 */
export const getBotsByBotIdEvolutionLogsByIdQuery = defineQueryOptions((options: Options<GetBotsByBotIdEvolutionLogsByIdData>) => ({
    key: getBotsByBotIdEvolutionLogsByIdQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdEvolutionLogsById({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 */
export const postBotsByBotIdEvolutionLogsByIdCompleteMutation = (options?: Partial<Options<PostBotsByBotIdEvolutionLogsByIdCompleteData>>): UseMutationOptions<PostBotsByBotIdEvolutionLogsByIdCompleteResponse, Options<PostBotsByBotIdEvolutionLogsByIdCompleteData>, PostBotsByBotIdEvolutionLogsByIdCompleteError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdEvolutionLogsByIdComplete({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdPromptsQueryKey = (options: Options<GetBotsByBotIdPromptsData>) => createQueryKey('getBotsByBotIdPrompts', options);
 ...
 */
export const getBotsByBotIdPromptsQuery = defineQueryOptions((options: Options<GetBotsByBotIdPromptsData>) => ({
    key: getBotsByBotIdPromptsQueryKey(options),
    query: async (context) => {
 ...
 */
export const putBotsByBotIdPromptsMutation = (options?: Partial<Options<PutBotsByBotIdPromptsData>>): UseMutationOptions<PutBotsByBotIdPromptsResponse, Options<PutBotsByBotIdPromptsData>, PutBotsByBotIdPromptsError> => ({
    mutation: async (vars) => {
        const { data } = await putBotsByBotIdPrompts({
            ...options,
            ...vars,
            throwOnError: true
        });
