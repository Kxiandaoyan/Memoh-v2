...
// ensureSharedDir creates and returns the shared workspace directory for cross-agent coordination.
func (m *Manager) ensureSharedDir() (string, error) {
	shared := filepath.Join(m.dataRoot(), "shared")
