...
func NewModelsHandler(log *slog.Logger, service *models.Service, accountService *accounts.Service) *ModelsHandler {
...
func (h *ModelsHandler) requireAdmin(c echo.Context) error {
	return RequireAdmin(c, h.accountService)
}
...
func (h *ModelsHandler) Create(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("create model failed", slog.Any("error", err))
		return echo.NewHTTPError(http.StatusInternalServerError, "failed to create model")
	}
...
func (h *ModelsHandler) List(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("list models failed", slog.Any("error", err))
...
func (h *ModelsHandler) GetByID(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("get model failed", slog.String("id", id), slog.Any("error", err))
...
func (h *ModelsHandler) GetByModelID(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("get model by model_id failed", slog.String("modelId", modelID), slog.Any("error", err))
		return echo.NewHTTPError(http.StatusNotFound, "model not found")
	}
	return c.JSON(http.StatusOK, resp)
}
...
func (h *ModelsHandler) UpdateByID(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("update model failed", slog.String("id", id), slog.Any("error", err))
...
func (h *ModelsHandler) UpdateByModelID(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("update model by model_id failed", slog.String("modelId", modelID), slog.Any("error", err))
		return echo.NewHTTPError(http.StatusInternalServerError, "failed to update model")
	}
	return c.JSON(http.StatusOK, resp)
}
...
func (h *ModelsHandler) DeleteByID(c echo.Context) error {
	...
	if err := h.service.DeleteByID(c.Request().Context(), id); err != nil {
		h.logger.Error("delete model failed", slog.String("id", id), slog.Any("error", err))
		return echo.NewHTTPError(http.StatusInternalServerError, "failed to delete model")
	}
...
func (h *ModelsHandler) DeleteByModelID(c echo.Context) error {
	...
	if err := h.service.DeleteByModelID(c.Request().Context(), modelID); err != nil {
		h.logger.Error("delete model by model_id failed", slog.String("modelId", modelID), slog.Any("error", err))
		return echo.NewHTTPError(http.StatusInternalServerError, "failed to delete model")
	}
	return c.NoContent(http.StatusNoContent)
}
...
func (h *ModelsHandler) Count(c echo.Context) error {
	...
	if err != nil {
		h.logger.Error("count models failed", slog.Any("error", err))
		return echo.NewHTTPError(http.StatusInternalServerError, "failed to count models")
	}
