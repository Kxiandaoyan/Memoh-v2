...
[English](./README_EN.md) · [快速开始](#快速开始) · [功能详解](#功能详解) · [安装与升级](#安装与升级) · [使用教程](./doc/README.md)
...
完整的使用教程和技巧请查看 **[doc/](./doc/README.md)** 目录，涵盖：

- 快速上手、Bot 管理、Bot 设置详解
- 对话功能、平台接入（Telegram/飞书群聊行为）
- 记忆系统、容器与文件、MCP 工具与技能
- 自进化与心跳、子智能体、定时任务
- 模型与提供方、Token 用量、流程日志
- 系统设置、管理员设置、使用技巧
